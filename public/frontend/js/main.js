...
$(document).on('click','.size_section ul li input',function(){
    $('#dynamic_qty').html($(this).attr('data-qty-available'));
});
...
$(document).ready(function(){
    ...
    $('.no_product').parent('.col-md-4').hide();
    $('.mymobile_menu').hide();
    var tab =$('.pro-tab-menu ul li:first-child').find('a').attr('href');
    $('#'+tab).show();
});
